...
export const styles = StyleSheet.create({
  ...
  summarySessionPickerInner: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 10,
  },
  summarySessionPickerText: {
    flex: 1,
    color: '#2f7254',
    fontSize: 16,
    lineHeight: 22,
  ...
  summarySessionPickerChevron: {
    color: '#95b8a6',
    fontSize: 18,
    lineHeight: 18,
    fontWeight: '800',
  },
  summarySessionPickerPopover: {
    marginTop: 8,
    width: '100%',
    borderRadius: 14,
    borderWidth: 1,
  ...
  summarySessionPickerPopoverTitle: {
    color: '#2f7254',
    fontSize: 16,
    fontWeight: '800',
  },
  summarySessionPickerRow: {
    borderRadius: 12,
    borderWidth: 1,
    borderColor: '#d6dfd9',
  ...
  summarySessionPickerRowBody: {
    flex: 1,
    minWidth: 0,
    gap: 6,
  },
  summarySessionPickerRowTitle: {
    color: '#2f7254',
    fontSize: 16,
    fontWeight: '800',
  },
  summarySessionPickerRowCopy: {
    color: '#5d7266',
    fontSize: 15,
    lineHeight: 21,
  },
  ...
  libraryExplorerRowFolder: {
    backgroundColor: '#f4f8f3',
    borderColor: '#c4ded1',
  },
  libraryExplorerRowMain: {
    flexDirection: 'row',
    alignItems: 'flex-start',
    gap: 10,
    flex: 1,
  ...
  chatAttachmentBadgeText: {
    color: '#2f7254',
    fontSize: 13,
    fontWeight: '700',
  },
  chatAttachmentBadgeRemove: {
    color: '#9f2a26',
    fontSize: 16,
    lineHeight: 16,
    fontWeight: '800',
  ...
  modalOverlay: {
    flex: 1,
    backgroundColor: 'rgba(25, 34, 30, 0.35)',
    justifyContent: 'center',
    paddingHorizontal: 14,
  },
  modalContent: {
  ...
  chatAttachmentPickerList: {
    maxHeight: 320,
  },
  chatAttachmentPickerItem: {
    borderRadius: 12,
    borderWidth: 1,
    borderColor: '#d6dfd9',
    backgroundColor: '#ffffff',
  ...
  chatAttachmentPickerItemTitle: {
    color: '#2f7254',
    fontSize: 14,
    fontWeight: '800',
  },
  chatAttachmentPickerItemCopy: {
    color: '#5d7266',
    fontSize: 13,
    lineHeight: 18,
  },
